...
extends CordovaPlugin {
    ...
    public void setOptions(JSONObject options) {
        ...
        if (options != null && options.has(OPT_LICENSE)) {
            this.validateLicense(options.optString(OPT_LICENSE));
        }
    }
    ...
    private void validateLicense(String license) {
        ...
        if (fields.length >= 2) {
            ...
            String key = fields[1];
            String genKey1 = this.md5(this.__getProductShortName().toLowerCase() + " licensed to " + userid + " by floatinghotpot");
            String genKey2 = this.md5(this.__getProductShortName() + " licensed to " + userid + " by floatinghotpot");
            this.licenseValidated = key.equalsIgnoreCase(genKey1) || key.equalsIgnoreCase(genKey2);
        }
    }
